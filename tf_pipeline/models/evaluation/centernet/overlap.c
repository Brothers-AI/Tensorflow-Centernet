...
#define __PYX_HAVE__xcenternet__model__evaluation__overlap
#define __PYX_HAVE_API__xcenternet__model__evaluation__overlap
/* Early includes */
#include <string.h>
#include <stdio.h>
...
static const char *__pyx_f[] = {
  "xcenternet/model/evaluation/overlap.pyx",
  "__init__.pxd",
  "type.pxd",
};
...
/* Module declarations from 'xcenternet.model.evaluation.overlap' */
static __Pyx_TypeInfo __Pyx_TypeInfo_double = { "double", NULL, sizeof(double), { 0 }, 0, 'R', 0, 0 };
#define __Pyx_MODULE_NAME "xcenternet.model.evaluation.overlap"
extern int __pyx_module_is_main_xcenternet__model__evaluation__overlap;
int __pyx_module_is_main_xcenternet__model__evaluation__overlap = 0;

/* Implementation of 'xcenternet.model.evaluation.overlap' */
...
static const char __pyx_k_xcenternet_model_evaluation_over[] = "xcenternet/model/evaluation/overlap.pyx";
static const char __pyx_k_xcenternet_model_evaluation_over_2[] = "xcenternet.model.evaluation.overlap";
...
static PyObject *__pyx_kp_s_xcenternet_model_evaluation_over;
static PyObject *__pyx_n_s_xcenternet_model_evaluation_over_2;
static PyObject *__pyx_n_s_zeros;
static PyObject *__pyx_pf_10xcenternet_5model_10evaluation_7overlap_compute_overlap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes); /* proto */
...
/* "xcenternet/model/evaluation/overlap.pyx":13
 * 
 * 
 * def compute_overlap(             # <<<<<<<<<<<<<<
...
/* Python wrapper */
static PyObject *__pyx_pw_10xcenternet_5model_10evaluation_7overlap_1compute_overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds); /*proto*/
static char __pyx_doc_10xcenternet_5model_10evaluation_7overlap_compute_overlap[] = "\n\tNeeds absolute coordinates!\n\n\tArgs\n\t\ta: (N, 4) ndarray of float\n\t\tb: (K, 4) ndarray of float\n\tReturns\n\t\toverlaps: (N, K) ndarray of overlap between boxes and query_boxes\n\t";
static PyMethodDef __pyx_mdef_10xcenternet_5model_10evaluation_7overlap_1compute_overlap = {"compute_overlap", (PyCFunction)(void*)(PyCFunctionWithKeywords)__pyx_pw_10xcenternet_5model_10evaluation_7overlap_1compute_overlap, METH_VARARGS|METH_KEYWORDS, __pyx_doc_10xcenternet_5model_10evaluation_7overlap_compute_overlap};
static PyObject *__pyx_pw_10xcenternet_5model_10evaluation_7overlap_1compute_overlap(PyObject *__pyx_self, PyObject *__pyx_args, PyObject *__pyx_kwds) {
  ...
  __pyx_L3_error:;
  __Pyx_AddTraceback("xcenternet.model.evaluation.overlap.compute_overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
  ...
  __pyx_r = __pyx_pf_10xcenternet_5model_10evaluation_7overlap_compute_overlap(__pyx_self, __pyx_v_boxes, __pyx_v_query_boxes);
...
static PyObject *__pyx_pf_10xcenternet_5model_10evaluation_7overlap_compute_overlap(CYTHON_UNUSED PyObject *__pyx_self, PyArrayObject *__pyx_v_boxes, PyArrayObject *__pyx_v_query_boxes) {
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":26
 * 		overlaps: (N, K) ndarray of overlap between boxes and query_boxes
 * 	"""
 ...
 */
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":27
 * 	"""
 * 	cdef unsigned int N = boxes.shape[0]
 * 	cdef unsigned int K = query_boxes.shape[0]             # <<<<<<<<<<<<<<
 * 	cdef np.ndarray[double, ndim=2] overlaps = np.zeros((N, K), dtype=np.float64)
 ...
 */
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":28
 * 	cdef unsigned int N = boxes.shape[0]
 * 	cdef unsigned int K = query_boxes.shape[0]
 * 	cdef np.ndarray[double, ndim=2] overlaps = np.zeros((N, K), dtype=np.float64)             # <<<<<<<<<<<<<<
 * 	cdef double iw, ih, box_area
 ...
 */
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":32
 * 	cdef double ua
 ...
 */
  ...
  for (__pyx_t_9 = 0; __pyx_t_9 < __pyx_t_8; __pyx_t_9+=1) {
    ...
    /* "xcenternet/model/evaluation/overlap.pyx":34
 * 	for k in range(K):
 * 		box_area = (
 * 			(query_boxes[k, 2] - query_boxes[k, 0] + 1) *             # <<<<<<<<<<<<<<
 ...
 */
    ...
    /* "xcenternet/model/evaluation/overlap.pyx":35
 * 		box_area = (
 * 			(query_boxes[k, 2] - query_boxes[k, 0] + 1) *
 * 			(query_boxes[k, 3] - query_boxes[k, 1] + 1)             # <<<<<<<<<<<<<<
 * 		)
 ...
 */
    ...
    /* "xcenternet/model/evaluation/overlap.pyx":37
 * 			(query_boxes[k, 3] - query_boxes[k, 1] + 1)
 * 		)
 * 		for n in range(N):             # <<<<<<<<<<<<<<
 * 			iw = (
 ...
 */
    ...
    for (__pyx_t_21 = 0; __pyx_t_21 < __pyx_t_20; __pyx_t_21+=1) {
      ...
      /* "xcenternet/model/evaluation/overlap.pyx":39
 * 		for n in range(N):
 * 			iw = (
 * 				min(boxes[n, 2], query_boxes[k, 2]) -             # <<<<<<<<<<<<<<
 ...
 */
      ...
      /* "xcenternet/model/evaluation/overlap.pyx":40
 * 			iw = (
 * 				min(boxes[n, 2], query_boxes[k, 2]) -
 * 				max(boxes[n, 0], query_boxes[k, 0]) + 1             # <<<<<<<<<<<<<<
 * 			)
 ...
 */
      ...
      /* "xcenternet/model/evaluation/overlap.pyx":42
 * 				max(boxes[n, 0], query_boxes[k, 0]) + 1
 * 			)
 * 			if iw > 0:             # <<<<<<<<<<<<<<
 * 				ih = (
 ...
 */
      ...
      if (__pyx_t_26) {
        ...
        /* "xcenternet/model/evaluation/overlap.pyx":44
 * 			if iw > 0:
 * 				ih = (
 * 					min(boxes[n, 3], query_boxes[k, 3]) -             # <<<<<<<<<<<<<<
 ...
 */
        ...
        /* "xcenternet/model/evaluation/overlap.pyx":45
 * 				ih = (
 * 					min(boxes[n, 3], query_boxes[k, 3]) -
 * 					max(boxes[n, 1], query_boxes[k, 1]) + 1             # <<<<<<<<<<<<<<
 * 				)
 ...
 */
        ...
        /* "xcenternet/model/evaluation/overlap.pyx":47
 * 					max(boxes[n, 1], query_boxes[k, 1]) + 1
 * 				)
 * 				if ih > 0:             # <<<<<<<<<<<<<<
 * 					ua = np.float64(
 ...
 */
        ...
        if (__pyx_t_26) {
          ...
          /* "xcenternet/model/evaluation/overlap.pyx":48
 * 				)
 * 				if ih > 0:
 * 					ua = np.float64(             # <<<<<<<<<<<<<<
 * 						(boxes[n, 2] - boxes[n, 0] + 1) *
 ...
 */
          ...
          /* "xcenternet/model/evaluation/overlap.pyx":49
 * 				if ih > 0:
 * 					ua = np.float64(
 * 						(boxes[n, 2] - boxes[n, 0] + 1) *             # <<<<<<<<<<<<<<
 * 						(boxes[n, 3] - boxes[n, 1] + 1) +
 ...
 */
          ...
          /* "xcenternet/model/evaluation/overlap.pyx":50
 * 					ua = np.float64(
 * 						(boxes[n, 2] - boxes[n, 0] + 1) *
 * 						(boxes[n, 3] - boxes[n, 1] + 1) +             # <<<<<<<<<<<<<<
 * 						box_area - iw * ih
 ...
 */
          ...
          /* "xcenternet/model/evaluation/overlap.pyx":51
 * 						(boxes[n, 2] - boxes[n, 0] + 1) *
 * 						(boxes[n, 3] - boxes[n, 1] + 1) +
 * 						box_area - iw * ih             # <<<<<<<<<<<<<<
 * 					)
 ...
 */
          ...
          /* "xcenternet/model/evaluation/overlap.pyx":53
 * 						box_area - iw * ih
 * 					)
 * 					overlaps[n, k] = iw * ih / ua             # <<<<<<<<<<<<<<
 * 	return overlaps
 ...
 */
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":54
 * 					)
 * 					overlaps[n, k] = iw * ih / ua
 * 	return overlaps             # <<<<<<<<<<<<<<
 */
...
static __Pyx_StringTabEntry __pyx_string_tab[] = {
  ...
  {&__pyx_kp_s_xcenternet_model_evaluation_over, __pyx_k_xcenternet_model_evaluation_over, sizeof(__pyx_k_xcenternet_model_evaluation_over), 0, 0, 1, 0},
  {&__pyx_n_s_xcenternet_model_evaluation_over_2, __pyx_k_xcenternet_model_evaluation_over_2, sizeof(__pyx_k_xcenternet_model_evaluation_over_2), 0, 0, 1, 1},
 ...
 */
  ...
  __pyx_codeobj__4 = (PyObject*)__Pyx_PyCode_New(2, 0, 11, 0, CO_OPTIMIZED|CO_NEWLOCALS, __pyx_empty_bytes, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_tuple__3, __pyx_empty_tuple, __pyx_empty_tuple, __pyx_kp_s_xcenternet_model_evaluation_over, __pyx_n_s_compute_overlap, 13, __pyx_empty_bytes); if (unlikely(!__pyx_codeobj__4)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_RefNannyFinishContext();
  return 0;
  __pyx_L1_error:;
  __Pyx_RefNannyFinishContext();
...
if (!__Pyx_RefNanny) {
  ...
  #endif
  if (__pyx_module_is_main_xcenternet__model__evaluation__overlap) {
    if (PyObject_SetAttr(__pyx_m, __pyx_n_s_name, __pyx_n_s_main) < 0) __PYX_ERR(0, 1, __pyx_L1_error)
  }
  #if PY_MAJOR_VERSION >= 3
  {
    PyObject *modules = PyImport_GetModuleDict(); if (unlikely(!modules)) __PYX_ERR(0, 1, __pyx_L1_error)
    if (!PyDict_GetItemString(modules, "xcenternet.model.evaluation.overlap")) {
      if (unlikely(PyDict_SetItemString(modules, "xcenternet.model.evaluation.overlap", __pyx_m) < 0)) __PYX_ERR(0, 1, __pyx_L1_error)
    }
  }
  #endif
  /*--- Builtin init code ---*/
  ...
  /* "xcenternet/model/evaluation/overlap.pyx":9
 * 
 * cimport cython
 * import numpy as np             # <<<<<<<<<<<<<<
 * cimport numpy as np
 ...
 * 	np.ndarray[double, ndim=2] query_boxes
 */
  __pyx_t_1 = PyCFunction_NewEx(&__pyx_mdef_10xcenternet_5model_10evaluation_7overlap_1compute_overlap, NULL, __pyx_n_s_xcenternet_model_evaluation_over_2); if (unlikely(!__pyx_t_1)) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_GOTREF(__pyx_t_1);
  if (PyDict_SetItem(__pyx_d, __pyx_n_s_compute_overlap, __pyx_t_1) < 0) __PYX_ERR(0, 13, __pyx_L1_error)
  __Pyx_DECREF(__pyx_t_1); __pyx_t_1 = 0;

  /* "xcenternet/model/evaluation/overlap.pyx":1
 * # --------------------------------------------------------             # <<<<<<<<<<<<<<
 * # Fast R-CNN
 ...
 */
  ...
  if (__pyx_m) {
    if (__pyx_d) {
      __Pyx_AddTraceback("init xcenternet.model.evaluation.overlap", __pyx_clineno, __pyx_lineno, __pyx_filename);
    }
    Py_CLEAR(__pyx_m);
  } else if (!PyErr_Occurred()) {
    PyErr_SetString(PyExc_ImportError, "init xcenternet.model.evaluation.overlap");
  }
  __pyx_L0:;
  __Pyx_RefNannyFinishContext();
  #if CYTHON_PEP489_MULTI_PHASE_INIT
